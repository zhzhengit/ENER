...
from .collate_functions import tagger_collate_to_max_length
...
def get_dataloader(args, tokenizer, prefix, shuffle, limit: int = None):
    """get train/dev/test dataloader"""
    data_path = os.path.join(args.data_dir, f"{prefix}{args.data_file_suffix}")
    dataset = TaggerNERDataset(data_path, tokenizer, args.data_sign,
                                max_length=args.max_length, is_chinese=args.chinese,
                                pad_to_maxlen=False)
